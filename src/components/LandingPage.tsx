...
export function LandingPage() {
  useEffect(() => {
    const items = Array.from(document.querySelectorAll('.hr-landing section, .hr-landing article, .hr-landing .hr-stat, .hr-landing .hr-learning-card'));
  ...
  return <div className="hr-landing">
    ...
    <section className="hr-reflection hr-shell" aria-label="هزینه یادگیری هوش مصنوعی"><span className="hr-quote-mark" aria-hidden="true">“</span><blockquote>هزینه‌ی یادگیری هوش مصنوعی، زمان است.<br className="hr-quote-break" /> <strong>هزینه‌ی یادنگرفتنش، جایگاه است.</strong></blockquote><span className="hr-quote-rule" aria-hidden="true" /></section>
    <FutureSection /><CoursesSection />
